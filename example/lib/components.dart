      ...
      body: ListView(
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              Ksir.text('为了节省代码，更加符合css编写习惯，对文字和图片组件进行了封装，使用如下：', lineHeight: 1.2),
              ...
              Ksir.text(demo01, lineHeight: 1.2),
              SizedBox(height: setSize(60),),
              Ksir.image('http://via.placeholder.com/350x150', width: 500, height: 500, fit: BoxFit.cover),
              Ksir.text(demo02, lineHeight: 1.2),
              SizedBox(height: setSize(60),),
              Ksir.avatar('http://via.placeholder.com/350x150', width: 200),
              Ksir.text(demo03, lineHeight: 1.2),
            ],
          )
        ],
      ),
